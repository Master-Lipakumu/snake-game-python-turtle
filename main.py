...
# creation graphique de turtle

screen = turtle.Screen()

#définisons la hauter (h) et la largeur (w)

screen.setup(w,h)

# définissons le titre

screen.title("Evolution Prime Snack")

#définissons le background
...
#définissons la forme du serpent

pen = turtle.Turtle("square")

pen.penup()

# définissons la nouriture du serpent ou la proie si vous voulez
